...
var WSSignaling = /** @class */ (function () {
    ...
    WSSignaling.prototype.onOffer = function (ws, message) {
        ...
        clients.forEach(function (_v, k) { return k.send(JSON.stringify({ from: connectionId, to: "", type: "offer", data: newOffer })); });
    };
    WSSignaling.prototype.onAnswer = function (ws, message) {
        ...
        clients.forEach(function (_v, k) { return k.send(JSON.stringify({ from: connectionId, to: "", type: "answer", data: newAnswer })); });
    };
